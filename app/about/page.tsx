        ...
        <div className="relative z-10 mx-auto max-w-[1200px] px-4 pb-16 sm:px-6 sm:pb-20 md:px-8 lg:pb-24">
          ...
          <header className="mb-12 grid grid-cols-1 gap-8 border-b border-[var(--border-color)] pb-10 pt-12 sm:mb-14 sm:pb-12 sm:pt-14 lg:mb-16 lg:grid-cols-[1fr_auto] lg:items-end lg:pb-14 lg:pt-20">
            <div>
              ...
              <h1
                className="text-[clamp(34px,11vw,82px)] font-extrabold leading-[0.96] tracking-[-0.035em] text-[var(--text-primary)]"
              ...
              <p className="mt-5 max-w-[760px] text-sm font-light leading-7 text-[var(--text-secondary)] sm:mt-6 sm:text-[15px] sm:leading-8 md:text-base md:leading-[1.9]">
            ...
            <div className="grid grid-cols-1 gap-px overflow-hidden rounded-2xl border border-[var(--border-color)] bg-[var(--card-border)] md:grid-cols-3">
              {quickFacts.map((item) => (
                <div key={item.label} className="bg-[var(--bg-primary)] p-5 sm:p-6 lg:p-7">
                  <div
                    className="mb-3 flex items-center gap-2 text-[10px] uppercase tracking-[0.14em] text-[var(--accent-text)] sm:mb-4"
                    style={{ fontFamily: "'DM Mono', monospace" }}
                  >
                    {item.icon}
                    {item.label}
                  ...
                  <h3
                    className="mb-2 text-[20px] font-bold tracking-[-0.02em] text-[var(--text-primary)] sm:text-[22px]"
                    style={{ fontFamily: "'Syne', sans-serif" }}
                  >
                    {item.value}
                  </h3>

                  <p className="text-[13px] font-light leading-7 text-[var(--text-secondary)] sm:text-[14px] sm:leading-[1.8]">
                    {item.sub}
                  </p>
                </div>
              ))}
          ...
          <section className="mb-12 grid grid-cols-1 gap-px overflow-hidden rounded-2xl border border-[var(--border-color)] bg-[var(--card-border)] lg:mb-16 lg:grid-cols-[1.15fr_0.85fr]">
            <div className="bg-[var(--bg-primary)] p-6 sm:p-8 md:p-10">
              <div
                className="mb-4 flex items-center gap-3 text-[10px] uppercase tracking-[0.16em] text-[var(--accent-text)] sm:mb-5"
                style={{ fontFamily: "'DM Mono', monospace" }}
              >
                <Code2 size={13} />
                What I do
              ...
              <h2
                className="mb-4 text-[26px] font-bold leading-[1.06] tracking-[-0.03em] text-[var(--text-primary)] sm:text-[32px] md:text-[38px] sm:mb-5"
                style={{ fontFamily: "'Syne', sans-serif" }}
              >
                I build across
                <br />
              ...
              <p className="max-w-[640px] text-[14px] font-light leading-7 text-[var(--text-secondary)] sm:text-[15px] sm:leading-[1.9]">
            ...
            <div className="flex flex-col justify-between bg-[var(--bg-secondary)] p-6 sm:p-8 md:p-10">
              <div>
                <div
                  className="mb-4 text-[10px] uppercase tracking-[0.16em] text-[var(--text-muted)] sm:mb-5"
                  style={{ fontFamily: "'DM Mono', monospace" }}
                >
                  Short profile
                </div>
              ...
              <div className="mt-7 border-t border-[var(--border-color)] pt-7 sm:mt-8 sm:pt-8">
                <div
                  className="mb-3 text-[9px] uppercase tracking-[0.14em] text-[var(--text-muted)]"
                  style={{ fontFamily: "'DM Mono', monospace" }}
                >
                  Current direction
                </div>
            ...
            <div className="grid grid-cols-1 gap-px overflow-hidden rounded-2xl border border-[var(--border-color)] bg-[var(--card-border)] md:grid-cols-2 xl:grid-cols-3">
              {identityCards.map((item) => (
                <div key={item.title} className="bg-[var(--bg-primary)] p-5 sm:p-6 lg:p-7">
                  ...
                  <h3
                    className="mb-3 text-[18px] font-bold tracking-[-0.02em] text-[var(--text-primary)] sm:text-[20px]"
                    style={{ fontFamily: "'Syne', sans-serif" }}
                  >
                    {item.title}
                  </h3>
            ...
            <div className="grid grid-cols-1 gap-px overflow-hidden rounded-2xl border border-[var(--border-color)] bg-[var(--card-border)] md:grid-cols-2 xl:grid-cols-3">
              {focusAreas.map((area) => (
                <div key={area.title} className="bg-[var(--bg-primary)] p-5 sm:p-6 lg:p-7">
                  <span
                    className="mb-4 inline-flex rounded border border-[var(--accent)] bg-[var(--accent-bg)] px-2 py-[4px] text-[10px] uppercase tracking-[0.14em] text-[var(--accent-text)]"
                    style={{ fontFamily: "'DM Mono', monospace" }}
                  >
                    {area.label}
                  </span>
              ...
              {stackGroups.map((group) => (
                <div key={group.title} className="bg-[var(--bg-primary)] p-5 sm:p-6 lg:p-7">
                  <div className="mb-4 flex items-center justify-between">
                    <h3
                      className="text-[16px] font-bold tracking-[-0.02em] text-[var(--text-primary)] sm:text-[17px]"
                      style={{ fontFamily: "'Syne', sans-serif" }}
                    >
                      {group.title}
                    </h3>
                    <div className="text-[var(--accent-text)]">{group.icon}</div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-[6px]">
                    {group.items.map((item) => (
                      <span
                        key={item}
                        className="rounded border border-[var(--border-color)] bg-[var(--bg-secondary)] px-2 py-[4px] text-[10px] tracking-[0.05em] text-[var(--text-secondary)]"
                        style={{ fontFamily: "'DM Mono', monospace" }}
                      >
                        {item}
                      </span>
            ...
            <div className="grid grid-cols-1 gap-px overflow-hidden rounded-2xl border border-[var(--border-color)] bg-[var(--card-border)] sm:grid-cols-2 xl:grid-cols-4">
              {learningNow.map((item, index) => (
                <div key={item} className="bg-[var(--bg-primary)] p-5 sm:p-6">
                  <div
                    className="mb-3 text-[10px] uppercase tracking-[0.12em] text-[var(--text-muted)]"
                    style={{ fontFamily: "'DM Mono', monospace" }}
                  >
          ...
          <section className="mb-12 sm:mb-14 lg:mb-16">
            ...
            <div className="grid grid-cols-1 gap-px overflow-hidden rounded-2xl border border-[var(--border-color)] bg-[var(--card-border)] md:grid-cols-2">
              {openSourceItems.map((item) => (
                <div key={item.title} className="bg-[var(--bg-primary)] p-5 sm:p-6 lg:p-7">
                  <div
                    className="mb-4 flex items-center gap-2 text-[10px] uppercase tracking-[0.14em] text-[var(--accent-text)]"
                    style={{ fontFamily: "'DM Mono', monospace" }}
                  >
                    <GitBranch size={12} />
                    {item.label}
          ...
          <section className="mb-16 sm:mb-18 lg:mb-20">
            ...
            <div className="flex flex-col gap-px overflow-hidden rounded-2xl border border-[var(--border-color)] bg-[var(--card-border)]">
              {journey.map((item) => (
                <div
                  key={item.title}
                  className="grid grid-cols-1 bg-[var(--bg-primary)] transition-colors hover:bg-[var(--bg-secondary)] md:grid-cols-[160px_1fr]"
                >
                  <div className="border-b border-[var(--border-color)] p-5 md:border-b-0 md:border-r md:p-7">
                    <span
                      className="text-[10px] uppercase tracking-[0.14em] text-[var(--accent-text)]"
                      style={{ fontFamily: "'DM Mono', monospace" }}
                    >
                      {item.year}
                    </span>
                  ...
                  <div className="p-5 md:p-7">
                    ...
                    <p className="max-w-[760px] text-[13px] font-light leading-7 text-[var(--text-secondary)] sm:text-[14px] sm:leading-[1.8]">
                      {item.desc}
                    </p>
                  </div>
                </div>
